...
public class MemberFcmTokenService {
    ...
    public void saveFcmToken(final MemberFcmTokenSaveRequest request) {
    ...
    private void updateExistingToken(final MemberFcmToken existingToken, String newFcmToken) {
